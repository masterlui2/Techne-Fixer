<template>
  <div class="portfolio-form-page">
    ...
    <div class="page-header">
      ...
      <p class="subtitle">Fill in the details to create a new portfolio project</p>
    </div>
...
.service-select, .color-select { padding: 0.75rem 1rem; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 0.95rem; font-family: inherit; background: white; cursor: pointer; transition: border-color 0.3s ease; }
